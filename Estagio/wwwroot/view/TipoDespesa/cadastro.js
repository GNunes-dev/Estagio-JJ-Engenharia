var cadastro = {
    ...
    carregaDados: function () {
        ...
        if (id != null) {
            ...
            fetch("/TipoDespesa/BuscarTipoDespesa?id=" + id, config)
                ...
                .then(function (dadosObj) {
                    ...
                    cadastro.carregaTipoDespesa(dadosObj);
                })
                .catch(function () {
                });
        }
    },
    carregaTipoDespesa: function (dadosObj) {
    ...
    btnCadastrar: function () {
        ...
        if (btnCadastrar.value == "Alterar") {
            ...
            fetch("/TipoDespesa/Editar", config)
                .then(function (dadosJson) {
                    var obj = dadosJson.json(); //deserializando
                    return obj;
                })
                .then(function (dadosObj) {
                    alert("Tipo de Despesa Alterado com sucesso");
                    window.location.href = "/TipoDespesa/pesquisa";
                })
                .catch(function () {
            ...
            if (valida.msg == "") {
                ...
                fetch("/TipoDespesa/Criar", config)
                    .then(function (dadosJson) {
                        var obj = dadosJson.json(); //deserializando
                        return obj;
                    })
                    .then(function (dadosObj) {
                        if (dadosObj.msg == "") {
                            alert("Tipo da Despesa cadastrado com sucesso");
